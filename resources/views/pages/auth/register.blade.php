<div class="px-4 py-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <x-atoms.logo class="w-auto h-16 mx-auto text-primary-600 dark:text-primary-400"/>
    ...
    <div class="px-4 py-8 sm:px-10 ">
        <form class="space-y-4">
            ...
            <div>
                <x-input lg label="{{ __('Email')}}" wire:model.live="email"
                         class="bg-secondary-50 dark:bg-secondary-700 dark:text-secondary-50"/>
            </div>
            ...
            <div>
                <x-password label="{{ __('Confirm Password') }}" wire:model="passwordConfirmation"
                            class="bg-secondary-50 dark:bg-secondary-700 dark:text-secondary-50"/>
            </div>

            <div class="mt-6">
                <x-atoms.action-button label="{{__('Register')}}" action="register"
